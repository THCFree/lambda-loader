...
class VersionControllerTest {
    ...
    private fun testMinecraftVersionAvailability(mcVersion: String) {
        ...
        ConfigManager.saveConfig(ConfigManager.config.copy(releaseMode = ReleaseMode.STABLE))
        ...
        ConfigManager.saveConfig(ConfigManager.config.copy(releaseMode = ReleaseMode.SNAPSHOT))
